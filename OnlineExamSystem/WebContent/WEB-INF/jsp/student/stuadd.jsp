...
<form:form id="addForm" class="form-inline" method="post" modelAttribute="examStu">
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body" style="text-align: center">
     		...
     		<div class="form-group">
           		<label>密码:</label>
				<form:password cssClass="form-control" maxlength="12" path="examStuPassword" /><br/>
				<form:errors cssClass="red" path="examStuPassword"/>
			</div><br/>
     		<div class="form-group">
           		<label>性别:</label>
				<form:radiobutton path="examStuSex" value="m" checked="checked"/>男 
